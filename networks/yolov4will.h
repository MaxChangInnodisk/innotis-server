...
namespace yolov4will {
    ...
    static const std::vector<float> YOLO_ANCHORS_1 = { 11, 19,  19, 32,  27, 47 };
    ...
    static const std::vector<float> YOLO_ANCHORS_2 = { 38, 62,  51, 92,  82, 74};
    ...
    static const std::vector<float> YOLO_ANCHORS_3 = {  75,129, 119,182, 213,274  };
